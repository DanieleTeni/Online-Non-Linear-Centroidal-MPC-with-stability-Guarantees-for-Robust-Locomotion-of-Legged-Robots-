...
class Hrp4Controller(dart.gui.osg.RealTimeWorldNode):
    def __init__(self, world, hrp4):
        ...
        self.id = id.InverseDynamics(self.hrp4, redundant_dofs,1)

             # initialize footstep planner
        reference = [(0.15, 0., 0)] * 10 + [(0.1, 0., 0.)] * 13 + [(0, 0., 0.)] * 10
        #omega in radiants
        ...
        self.logger.initialize_plot(frequency=50)
        ...
        self.logger3.initialize_plot(frequency=50)
