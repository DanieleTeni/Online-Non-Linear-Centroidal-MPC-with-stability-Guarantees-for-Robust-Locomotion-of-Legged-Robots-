...
def compute_knot(foot_tra,planner):
        ...
        knot_y.append(foot_tra.generate_feet_trajectories_at_time(0)[contact]['pos'][4]*0.52)
        #knot_y.append((foot_tra.generate_feet_trajectories_at_time(0)['lfoot']['pos'][4]+oot_tra.generate_feet_trajectories_at_time(0)['rfoot']['pos'][4])/2)
        ...
        for i in range(200,(len(planner.plan)-1)*100):
         if (i-271)%100==0 :
          ...
          # sequence_y.append(i)
          knot_y.append(foot_tra.generate_feet_trajectories_at_time(i)[contact]['pos'][4]*0.52)
