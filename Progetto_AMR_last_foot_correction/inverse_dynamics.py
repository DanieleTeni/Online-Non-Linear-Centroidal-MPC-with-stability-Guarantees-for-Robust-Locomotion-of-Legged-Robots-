...
class InverseDynamics:
    ...
    def get_joint_torques(self, desired, current, contact):
        ...
        #pos_gains = {'lfoot': 25., 'rfoot': 25., 'com':  10., 'torso': 2., 'base': 2., 'joints': 20.  }
        pos_gains = {'lfoot': 10., 'rfoot': 10., 'com':  5., 'torso': 1., 'base': 1., 'joints': 20.  }
        #vel_gains = {'lfoot': 10., 'rfoot': 10., 'com': 10., 'torso': 3., 'base': 3., 'joints': 1.e-1}
        vel_gains = {'lfoot': 5., 'rfoot': 5., 'com': 10., 'torso': 2., 'base': 2., 'joints': 1.e-1}
